...
namespace test_sha1 {
  ...
  using Digest = cs::ByteArray<cs::Hash::Size_SHA1>;

  bool test_digest(const std::string& message, const Digest& ref)
  {
    cs::Hash hash{cs::Hash::SHA1};
  ...
  TEST_CASE("Compute SHA-1 message digests.", "[sha1]") {
    ...
    REQUIRE( test_digest("abc", digest_No1) );
    ...
    REQUIRE( test_digest("", digest_No2) );
    ...
    REQUIRE( test_digest("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq", digest_No3) );
    ...
    REQUIRE( test_digest("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu", digest_No4) );
    ...
    REQUIRE( test_digest(test_util::makeMessage1M(), digest_No5) );
    ...
    REQUIRE( test_digest(test_util::makeMessageXL(), digest_No6) );
#endif
  }
