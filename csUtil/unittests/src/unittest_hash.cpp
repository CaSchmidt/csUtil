...
namespace test_sha224 {
  ...
  TEST_CASE("Compute SHA-224 message digests.", "[sha224]") {
    ...
    const Digest digest_No1{0x23, 0x09, 0x7d, 0x22, 0x34, 0x05, 0xd8, 0x22, 0x86, 0x42, 0xa4, 0x77, 0xbd, 0xa2, 0x55, 0xb3, 0x2a, 0xad, 0xbc, 0xe4, 0xbd, 0xa0, 0xb3, 0xf7, 0xe3, 0x6c, 0x9d, 0xa7};
    REQUIRE( test_digest<FUNC>("abc",
                               digest_No1) );

    const Digest digest_No2{0xd1, 0x4a, 0x02, 0x8c, 0x2a, 0x3a, 0x2b, 0xc9, 0x47, 0x61, 0x02, 0xbb, 0x28, 0x82, 0x34, 0xc4, 0x15, 0xa2, 0xb0, 0x1f, 0x82, 0x8e, 0xa6, 0x2a, 0xc5, 0xb3, 0xe4, 0x2f};
    REQUIRE( test_digest<FUNC>("",
                               digest_No2) );

    const Digest digest_No3{0x75, 0x38, 0x8b, 0x16, 0x51, 0x27, 0x76, 0xcc, 0x5d, 0xba, 0x5d, 0xa1, 0xfd, 0x89, 0x01, 0x50, 0xb0, 0xc6, 0x45, 0x5c, 0xb4, 0xf5, 0x8b, 0x19, 0x52, 0x52, 0x25, 0x25};
    REQUIRE( test_digest<FUNC>("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
                               digest_No3) );

    const Digest digest_No4{0xc9, 0x7c, 0xa9, 0xa5, 0x59, 0x85, 0x0c, 0xe9, 0x7a, 0x04, 0xa9, 0x6d, 0xef, 0x6d, 0x99, 0xa9, 0xe0, 0xe0, 0xe2, 0xab, 0x14, 0xe6, 0xb8, 0xdf, 0x26, 0x5f, 0xc0, 0xb3};
    REQUIRE( test_digest<FUNC>("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
                               digest_No4) );

    const Digest digest_No5{0x20, 0x79, 0x46, 0x55, 0x98, 0x0c, 0x91, 0xd8, 0xbb, 0xb4, 0xc1, 0xea, 0x97, 0x61, 0x8a, 0x4b, 0xf0, 0x3f, 0x42, 0x58, 0x19, 0x48, 0xb2, 0xee, 0x4e, 0xe7, 0xad, 0x67};
    REQUIRE( test_digest<FUNC>(makeMessage1M(),
                               digest_No5) );
    ...
    printf("Make message XL...\n"); fflush(stdout);
    const std::string message_No6 = makeMessageXL();
    const Digest digest_No6{0xb5, 0x98, 0x97, 0x13, 0xca, 0x4f, 0xe4, 0x7a, 0x00, 0x9f, 0x86, 0x21, 0x98, 0x0b, 0x34, 0xe6, 0xd6, 0x3e, 0xd3, 0x06, 0x3b, 0x2a, 0x0a, 0x2c, 0x86, 0x7d, 0x8a, 0x85};
    printf("Hash message XL...\n"); fflush(stdout);
    REQUIRE( test_digest<FUNC>(message_No6,
                               digest_No6) );
#endif
